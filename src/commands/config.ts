...
export class ConfigCommand {
  ...
  private async showConfig(): Promise<void> {
    ...
    this.printConfigItem("Company", config.company || "(not set)");
    ...
    this.printConfigItem("Team Data Dir", config.teamDataDir || "(not set)");
  ...
  private async setConfig(setValue: string): Promise<void> {
    ...
    // Validate key
    const validKeys: (keyof ReceiptConfig)[] = ["location", "timezone", "printer", "company", "teamDataDir"];
